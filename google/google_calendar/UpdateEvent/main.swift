...
/// Implementation of the Google Calendar Update Event capability
class GoogleCalendarUpdateEventCapability: BaseRemoteCapability {
    ...
    override func prepareRequestBody(from parameters: [String: String]) -> Data? {
        ...
        if let endDateTime = parameters["endDateTime"] {
        ...
        // If no fields were provided, return nil
...
let capability = GoogleCalendarUpdateEventCapability(
    organization: "google",
