...
/// Implementation of the Gmail Create Draft capability
class GmailCreateDraftCapability: BaseRemoteCapability {
    ...
    override func prepareRequestBody(from parameters: [String: String]) -> Data? {
        ...
        // Create a draft email structure
        let message = [
        ...
        let draftData = ["message": message]
        
        // Convert to JSON data
        return try? JSONSerialization.data(withJSONObject: draftData)
    }
...
let capability = GmailCreateDraftCapability(
    organization: "google",
    group: "gmail",
